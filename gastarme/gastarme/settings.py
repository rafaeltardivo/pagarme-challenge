"""
Django settings for gastarme project.
...
SECRET_KEY = 'f3gag4&)zv*r4atd+ig7zcm#q6ov3de&k)ky8fwl8i-p6dyv-i'
...
WSGI_APPLICATION = 'gastarme.wsgi.application'
